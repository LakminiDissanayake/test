  ...
  <head>
      ...
      <link rel="icon" href="resourses/logo.avif">
      ...
      <div class="container-fluid vh-100 d-flex justify-content-center">
          ...
          <div class="row align-content-center">
                  ...
                  <div class="row">
                      ...
                      <div class="col-12 col-lg-6 d-none" id="SignInBox">
                          <div class="row g-2">
                              ...
                              <div class="col-12 col-lg-6 d-grid">
                                  <button class="btn btn-danger" onclick="ChangeView();"> New to Cryptocurrency? Join Now </button>
                              </div>
                          </div>
                      </div>
              ...
              <div class="col-12 d-none d-lg-block fixed-bottom">
                  <p class="text-center">&copy;2023 Cryptocurrency || ALL Rights Reserved</p>
              </div>
